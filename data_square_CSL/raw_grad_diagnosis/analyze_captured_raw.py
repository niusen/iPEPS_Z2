...
def main():
    ...
    print("svd_ad_decomp_reg,", getattr(ctm_args, "svd_ad_decomp_reg", "not_set"))
    print("projector_min_singular_cutoff,", getattr(ctm_args, "projector_min_singular_cutoff", "not_set"))
