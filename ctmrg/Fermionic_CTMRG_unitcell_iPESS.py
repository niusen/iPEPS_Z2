...
def ctm_update_single_cx(cx,cy_max, Cset_cell, Tset_cell, state_double_layer, chi, direction, ctm_setting, global_args):
    ...
    for cy in range(1,cy_max+1):
        ...
        MMup=checkpoint(build_corner_MMup, coord,direction,double_B_cell,double_T_cell,Cset_cell,Tset_cell,Lx,Ly, use_reentrant=ctm_setting.use_reentrant);
        MMlow=checkpoint(build_corner_MMlow, coord,direction,double_B_cell,double_T_cell,Cset_cell,Tset_cell,Lx,Ly, use_reentrant=ctm_setting.use_reentrant);
        MMup_reflect=checkpoint(build_corner_MMup_reflect, coord,direction,double_B_cell,double_T_cell,Cset_cell,Tset_cell,Lx,Ly, use_reentrant=ctm_setting.use_reentrant);
        MMlow_reflect=checkpoint(build_corner_MMlow_reflect, coord,direction,double_B_cell,double_T_cell,Cset_cell,Tset_cell,Lx,Ly, use_reentrant=ctm_setting.use_reentrant);
